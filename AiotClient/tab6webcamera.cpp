...
{
    ui->setupUi(this);
    webcamUrl = QUrl("http://192.168.0.63:8080/?action=stream");
...
void Tab6WebCamera::camStartSlot(bool bCheck)
{
    ...
    QStringList webcamArg = {
        ...
        "-o", "/home/ubuntu/mjpg-streamer-master/output_http.so -w /home/ubuntu/mjpg-streamer-master/www -c user:1234"
    };
